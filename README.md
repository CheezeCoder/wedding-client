...
Client side wedding page for our wedding that was in September 2018.

The Website currently uses firebase as a backend and the credentials in `firebaseStore.ts` are for
our sepecific wedding.
